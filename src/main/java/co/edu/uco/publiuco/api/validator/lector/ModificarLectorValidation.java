...
public final class ModificarLectorValidation implements Validation<LectorDTO>{

	public static final Result validate(final LectorDTO data) {
		return new ModificarLectorValidation().execute(data);
	}
	private ModificarLectorValidation() {
		super();
	}
	...
	public Result execute(final LectorDTO data) {
		...
		if(UtilObject.isNull(data)) {
			result.addMessage("No es posible modificar el lector");
		}else {
