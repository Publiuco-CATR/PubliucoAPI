...
import co.edu.uco.publiuco.api.validator.persona.common.EstadoValidation;
...
public final class RegistrarPersonaValidation implements Validation<PersonaDTO>{

	public static final Result validate(final PersonaDTO data) {
		return new RegistrarPersonaValidation().execute(data);
	}
	private RegistrarPersonaValidation() {
		super();
	}
	...
	public Result execute(final PersonaDTO data) {
		...
		if(UtilObject.isNull(data)) {
			result.addMessage("No es posible registrar una nueva persona");
		}else {
